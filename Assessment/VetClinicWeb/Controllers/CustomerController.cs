...
using VetClinicSolution.Helpers;
using VetClinicSolution.ViewModels;

namespace VetClinicSolution.Controllers
{
    ...
    public class CustomerController : ControllerBase
    {
        ...
        public async Task<string> Email()
        {
            ...
            (bool success, string errorMsg) = await _emailSender.SendEmailAsync(recepientName, recepientEmail, "Test Email from VetClinicSolution", message);

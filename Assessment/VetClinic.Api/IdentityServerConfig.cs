...
namespace VetClinic.Api
{
    ...
    {
        public const string ApiName = "vetclinic_api";
        public const string ApiFriendlyName = "VetClinic API";
        public const string VetClinicAppClientID = "vetclinic_spa";
        ...
        public static IEnumerable<Client> GetClients()
        {
            ...
            return new List<Client>
            {
                ...
                new Client
                {
                    ...
                    //AbsoluteRefreshTokenLifetime = 7200, //2 hours
